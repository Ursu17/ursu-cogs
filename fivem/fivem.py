...
class FiveM(commands.Cog):
    ...
    def __init__(self, bot: Red):
        ...
        self.config.register_global(
            ip=None,
            toggled=False,
            text="{players}/{total} playeri conectati pe {server_ip}!",
            status="online",
    ...
    async def activitystream(
        ...
        Advanced example: `[p]fivemset activitystream summit1g {players}/{total} players are connected on FuryRp, check out my stream!`
        """
        ...
        async with ctx.typing():
            ...
            for page in pagify(msg, delims=["\n"], page_length=800):
                ...
                em = discord.Embed(
                    ...
                    title=f"{len(data_players)}/{data_server['vars']['sv_maxClients']} jucatori conectati:",
